	  	...
	  	layui.use('upload', function(){
	   	...
	   	$(document).ready(function(){
    		...
    		$("#savebtn").click(function (){
	    		...
	    		var id = $("#id").val();
	    		var url = "${CONTEXT_PATH }/slnmcase/doAddPage";
	    		if(id != ""){
	    			url = "${CONTEXT_PATH }/slnmcase/doUpdatePage";
	    		}
	   		...
	   		$("#savetotempbtn").click(function (){
	    		...
	    		var url = "${CONTEXT_PATH }/slnmcase/doAddPageToTemp";
...
<tu:content contentId="content">
	<div class="dialog-middle">
		<form id="tuform" class="layui-form" action="${CONTEXT_PATH }/slnmcase/toAddPage" method="post">
					...
					<td width="65%">
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="" value="${slnmChapter.chaptername }" 
	...
	<div class="dialog-bottom">
		...
		<button class="layui-btn" id="savetotempbtn">保存至模板</button>
