   	...
   	<script type="text/javascript">
	  	$(document).ready(function(){
    		...
    		$("#savebtn").click(function (){
	    		...
	    		var id = $("#id").val();
	    		var url = "${CONTEXT_PATH }/slnmcase/doAddLocator";
	    		if(id != ""){
	    			url = "${CONTEXT_PATH }/slnmcase/doUpdateLocator";
	    		}
...
<tu:content contentId="content">
	<div class="dialog-middle">
		<form id="tuform" class="layui-form" action="${CONTEXT_PATH }/slnmcase/toAddLocator" method="post">
