   	...
   	<script type="text/javascript">
	  	$(document).ready(function(){
    		...
    		$("#savebtn").click(function (){
	    		...
	    		var id = $("#id").val();
	    		var url = "${CONTEXT_PATH }/slnmpagetemp/doAddLocator";
	    		if(id != ""){
	    			url = "${CONTEXT_PATH }/slnmpagetemp/doUpdateLocator";
	    		}
...
<tu:content contentId="content">
	<div class="dialog-middle">
		<form id="tuform" class="layui-form" action="${CONTEXT_PATH }/slnmpagetemp/toAddLocator" method="post">
			<input type="hidden" name="id" id="id" value="${bean.id }" />
			<input type="hidden" name="pagecode" id="pagecode" value="${slnmPage.pagecode }" />
					...
					<td width="65%">
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="" value="${slnmPage.pagename }" 
					...
					<td>
						<div class="layui-form-item">
							...
							<div class="layui-input-block" style="width:250px;" id="opttype-select-tip">
								<select name="opttype" id="opttype" tip="操作" lay-filter="lay-select">
