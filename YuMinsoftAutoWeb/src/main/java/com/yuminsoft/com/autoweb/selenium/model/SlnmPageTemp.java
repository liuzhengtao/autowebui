...
@Entity
@Table(name="slnm_page_temp")
public class SlnmPageTemp {
    //自增主键,唯一
    @Id
    ...
    /* 非数据库字段  */
    @Transient
    private List<SlnmLocatorTemp> locatorlist;
    ...
    public List<SlnmLocatorTemp> getLocatorlist() {
        return locatorlist;
    }
    public void setLocatorlist(List<SlnmLocatorTemp> locatorlist) {
